...
class IkonFrame(wx.Frame):
	...
	def __init__(self, position=(400,500), parent=None, ClosePrompt=False, SaveRestore=False):
		wx.Frame.__init__(self, parent, title = 'DP Andor iKon Startup', pos = position, size = (WINDOW_WIDTH, WINDOW_HEIGHT), style=wx.DEFAULT_FRAME_STYLE ^ wx.RESIZE_BORDER)
		...
		# Title:									
		self.title = wx.StaticText(self.background, label="Andor iKon")
