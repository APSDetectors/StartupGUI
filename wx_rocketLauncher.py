...
class StartFrame(wx.Frame):
	...
	def __init__(self):
		...
		self.Bind(wx.EVT_MENU, self.helpDocs_101_Event, id=101)
		self.Bind(wx.EVT_MENU, self.helpDocs_102_Event, id=102)
		self.Bind(wx.EVT_MENU, self.helpDocs_103_Event, id=103)
		...
		self.Bind(wx.EVT_MENU, self.Pager_Event, id=201)
		self.Bind(wx.EVT_MENU, self.DPGeneral_Event, id=202)
		self.Bind(wx.EVT_MENU, self.DetectorGroup_Event, id=203)
		self.Bind(wx.EVT_MENU, self.Requests_Event, id=204)
		self.Bind(wx.EVT_MENU, self.VersionList_Event, id=205)
		...
		self.Bind(wx.EVT_MENU, self.Connect_Event, id=401)
		self.Bind(wx.EVT_MENU, self.Help_Event, id=402)
